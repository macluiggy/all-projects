...
const data: Data = [
	{
		...
		description: 'In this microservice you can create a username and it automatically adds an id, then you can use that id to add an exercise to the user log',
		...
		"source_code": 'https://github.com/macluiggy/boilerplate-project-exercisetracker',
